      ...
      <table class="table table-striped b-t b-light">
		...
		?>
             ...
             <tr>
			   ...
			   <td><a href="Player_edit.php?cid=<?php echo $row['Player_Id'];?>" class="fa fa-edit" > 	<a onclick="return confirm('Are you sure you want to delete?'); "
	<a href="plyer_delete.php?Player_Id=<?php echo $row['Player_Id'];?>" class="fa fa-trash"></td>
			  </tr>
